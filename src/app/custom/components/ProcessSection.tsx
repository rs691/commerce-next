        ...
        <div className="mt-12 relative">
          ...
          <div className="space-y-16">
            <div className="reveal grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex items-center justify-center text-4xl bg-white w-24 h-24 rounded-full shadow-lg mx-auto md:mx-0">
                &#x1F4DD;
              </div>
            </div>
            
            <div className="reveal grid md:grid-cols-2 gap-8 items-center">
              <div className="flex items-center justify-center text-4xl bg-white w-24 h-24 rounded-full shadow-lg mx-auto md:mx-0 md:order-last">
                &#x1F333;
              </div>
